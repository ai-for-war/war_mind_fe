## Purpose
Define the protected stock research workspace, including report history, create-report flow, detail rendering, and explicit refresh behavior inside the authenticated app shell.
