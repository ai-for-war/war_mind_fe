class MeetingSourceProcessor extends AudioWorkletProcessor {
  process(inputs) {
    ...
    if (inputChannels.length === 1) {
      ...
      for (let frameIndex = 0; frameIndex < frameCount; frameIndex += 1) {
        ...
        for (
          let channelIndex = 0;
          channelIndex < inputChannels.length;
          channelIndex += 1
        ) {
...
registerProcessor("meeting-source-processor", MeetingSourceProcessor)
