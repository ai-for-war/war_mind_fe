...
export interface SuperAgentToolPresentation {
...
const TOOL_PRESENTATION_REGISTRY: Record<string, SuperAgentToolPresentation> = {
  fetch_content: {
...
): string | null => getSuperAgentToolPresentation(toolName).formatArguments(argumentsValue)
