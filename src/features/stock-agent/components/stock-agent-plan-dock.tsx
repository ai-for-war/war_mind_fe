...
type StockAgentPlanDockProps = {
  className?: string
  plan: StockAgentPlanSnapshot
...
const getPlanHeadline = (plan: StockAgentPlanSnapshot, runStatus: StockAgentRunStatus): string => {
  if (runStatus === "failed") {
...
export const StockAgentPlanDock = ({
  className,
  plan,
  runStatus,
}: StockAgentPlanDockProps) => {
