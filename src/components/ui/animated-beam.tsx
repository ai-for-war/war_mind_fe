    ...
    const updatePath = () => {
      if (containerRef.current && fromRef.current && toRef.current) {
        ...
        const getAnchoredPoint = (
          center: typeof centerA,
          target: typeof centerA,
          rect: DOMRect,
          anchor: BeamAnchor
        ) => {
          if (anchor === "center") {
        ...
        const startPoint = getAnchoredPoint(centerA, centerB, rectA, fromAnchor)
        const endPoint = getAnchoredPoint(centerB, centerA, rectB, toAnchor)
